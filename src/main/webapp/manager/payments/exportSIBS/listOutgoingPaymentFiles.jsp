...
<fr:view	name="sibsOutgoingPaymentFiles" >
	<fr:schema bundle="MANAGER_RESOURCES" type="pt.ist.fenix.domain.accounting.events.export.SIBSOutgoingPaymentFile">
...
<fr:view	name="sibsOutgoingPaymentQueueJobs" sortBy="requestDate=desc">
	<fr:schema bundle="MANAGER_RESOURCES" type="pt.ist.fenix.domain.accounting.events.export.SIBSOutgoingPaymentQueueJob">
